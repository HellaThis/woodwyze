    ...
    <nav className="bg-green-900 text-white px-6 py-4 shadow-md">
      ...
      {isOpen && (
        <ul className="md:hidden bg-green-900 text-white space-y-4 p-4 mt-2 rounded-lg">
          ...
          <li>
            <Link href="/adam/branches" onClick={() => setIsOpen(false)}
                  className="text-white hover:text-green-300">Branches</Link>
          </li>
          <li>
            <Link href="/marketplace" onClick={() => setIsOpen(false)}
                  className="text-white hover:text-green-300">Marketplace</Link>
          </li>
        </ul>
      )}
    </nav>
